...
`seqnereval` allows you to efficiently perform extensive error analysis on your NER models. It allows you to:
...
One of the key motivation behind writing this module was to provide an easier and more optimal way of evaluating NER models. It was inspired by some existing NER model evaluation packages and was designed keeping performance in mind, so you can get your results faster than most of the existing NER evaluation packages.
## Installation
